...
export default function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" className="bg-white px-6 py-20 border-b border-[#E5E7EB]">
          ...
          {TESTIMONIALS.map((t, i) => (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <svg viewBox="0 0 24 24" className="w-4 h-4 flex-shrink-0" aria-label="Google review" title="Verified Google Review">
